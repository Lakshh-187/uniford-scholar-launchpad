...
const SEP1300Page: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-12 bg-slate-50">
      
      <header className="text-center py-8 bg-gradient-to-r from-wsy-purple to-wsy-teal text-white rounded-lg shadow-xl">
        <h1 className="text-4xl font-bold mb-2">SEP-1300: Your Guide to Career Success</h1>
        <p className="text-xl text-purple-100">Roadmap, Portfolio Building, Internships, and Modern Skills</p>
      </header>

      <Card className="shadow-lg rounded-xl">
        <CardHeader>
          <CardTitle className="text-2xl font-semibold text-wsy-blue flex items-center"><GraduationCap className="mr-3 h-7 w-7 text-wsy-purple"/>Roadmap & Credible Portfolio for "Campus to Corporate" Aspirants</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4 text-gray-700">
          <p className="italic text-gray-600">Join a startup as a first internship where you try every domain and can explore many categories. After gaining exposure to various domains, you can choose one that aligns with your interests and strengths, then pursue 2-3 domain-based internships. Participate extensively in competitions and projects. Build and collaborate to complete major problem-solving projects.</p>
          <p className="font-semibold text-gray-800">Note: During this journey, focus on building as many connections and networks as possible. Practical exposure and connections will help build a credible portfolio and make it easier to get referrals and Letters of Recommendation (LOR) for direct career opportunities.</p>
          <div>
            <h4 className="font-semibold text-lg text-wsy-purple mb-3 flex items-center"><Target className="mr-2 h-5 w-5"/>Key Journey Steps:</h4>
            <ul className="list-disc list-inside space-y-1.5 pl-5 text-gray-600">
      ...
      <section>
        <h2 className="text-3xl font-bold text-center mb-10 text-wsy-purple flex items-center justify-center"><HelpCircle className="mr-3 h-8 w-8"/>Common Career Challenges & Solutions</h2>
        <Accordion type="single" collapsible className="w-full space-y-4">
          {[
            ...
            <AccordionItem value={item.id} key={item.id} className="bg-white border rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              <AccordionTrigger className="p-6 text-left font-medium text-wsy-blue hover:no-underline text-base">
                <div className="flex items-start gap-3">
                  <Lightbulb className="h-6 w-6 text-yellow-500 mt-0.5 shrink-0" />
                  {item.question}
                </div>
              </AccordionTrigger>
              <AccordionContent className="p-6 pt-2 text-gray-700 whitespace-pre-line">
                {item.answer}
              </AccordionContent>
            </AccordionItem>
          ))}
      ...
      <Card className="shadow-lg rounded-xl">
        <CardHeader>
          <CardTitle className="text-2xl font-semibold text-wsy-blue flex items-center"><Briefcase className="mr-3 h-7 w-7 text-wsy-purple"/>Internship Guidance</CardTitle>
          <CardDescription className="text-gray-500">We guide students with different methods, tips & ways.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4 text-gray-700">
          <p><strong className="text-red-600 font-semibold">Internship:</strong> Avoid paid internships (also called training programs) that have no value, as they are like a course with a certificate.</p>
          ...
          <div>
            <h4 className="font-semibold text-lg text-wsy-purple mb-3">Best Ways to Get Internships:</h4>
            <ol className="list-decimal list-inside space-y-2.5 pl-5 text-gray-600">
              ...
              <li>You can also use CAF – one application form for many opportunities, as many non-profit organizations provide it to their scholars. By checking eligibility, you can also apply & after getting an ID card, it's the organization's responsibility to provide an internship to you.
                <Button size="sm" variant="outline" className="ml-2 mt-1 border-wsy-teal text-wsy-teal hover:bg-wsy-teal/10"><LinkIcon className="mr-1 h-4 w-4"/>Apply for CAF</Button>
              </li>
            </ol>
          </div>

          <p className="font-semibold mt-4 text-gray-800">Note: We only suggest & connect with non-profit organizations, free & modern ways. We are totally against paid & high-fee opportunities.</p>
          ...
          <div className="flex flex-wrap gap-4 mt-6">
            <Button variant="purple"><Star className="mr-2 h-4 w-4"/>Apply Now (for ID Card)</Button>
            <Button variant="outline"><HelpCircle className="mr-2 h-4 w-4"/>Help Desk</Button>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <Card className="shadow-lg rounded-xl">
          <CardHeader>
            <CardTitle className="text-xl font-semibold text-wsy-blue flex items-center"><Users className="mr-2 h-6 w-6 text-wsy-purple"/>Participate to Enhance Your Profile</CardTitle>
          </CardHeader>
        ...
        <Card className="shadow-lg rounded-xl">
          <CardHeader>
            <CardTitle className="text-xl font-semibold text-wsy-blue flex items-center"><FileText className="mr-2 h-6 w-6 text-wsy-purple"/>LOR (Letter of Recommendation)</CardTitle>
          </CardHeader>
          <CardContent className="text-gray-700 space-y-3">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <Card className="shadow-lg rounded-xl">
          <CardHeader>
            <CardTitle className="text-xl font-semibold text-wsy-blue flex items-center"><Zap className="mr-2 h-6 w-6 text-wsy-purple"/>Modern Tools</CardTitle>
          </CardHeader>
          <CardContent className="text-gray-700 space-y-3">
            ...
            <p>If you want a free certification internship where you learn & implement & get a UNSR verified certificate, you can apply <Button variant="link" className="p-0 h-auto text-wsy-purple">here</Button>.</p>
          </CardContent>
        </Card>

        <Card className="shadow-lg rounded-xl">
          <CardHeader>
            <CardTitle className="text-xl font-semibold text-wsy-blue flex items-center"><Lightbulb className="mr-2 h-6 w-6 text-wsy-purple"/>AI Creator</CardTitle>
          </CardHeader>
          <CardContent className="text-gray-700 space-y-3">
            ...
            <p className="font-semibold mt-2 text-gray-800">Note: You can access all resources, knowledge & internships without paying any fees. Be aware.</p>
          </CardContent>
        </Card>
      </div>

      <section className="pt-8">
        <h2 className="text-3xl font-bold text-center mb-10 text-wsy-purple flex items-center justify-center"><MessageSquare className="mr-3 h-8 w-8"/>Featured Queries</h2>
        <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-8">
          {sampleQueries.map((query) => (
            <Card key={query!.id} className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col overflow-hidden">
              <CardHeader className="pb-4">
                <div className="flex justify-between items-start mb-2">
                  <CardTitle className="text-xl font-semibold text-wsy-blue leading-tight">{query!.question}</CardTitle>
                  <Badge variant={query!.status === "Trending" ? "warning" : "success"} className="ml-2 shrink-0">{query!.status}</Badge>
                </div>
                <CardDescription className="text-sm text-gray-600 line-clamp-2">{query!.description}</CardDescription>
              </CardHeader>
              <CardContent className="flex-grow">
                <div className="flex flex-wrap gap-2 mb-3">
                  {query!.tags.map(tag => <Badge key={tag} variant="outline" className="text-xs">{tag}</Badge>)}
                </div>
                <p className="text-xs text-gray-500">Category: {query!.category} | Answers: {query!.answers}</p>
              </CardContent>
              <CardFooter className="bg-slate-50 p-4">
                <Button variant="purple" size="sm" className="w-full" onClick={() => openQueryDialog(query)}>
      ...
      <section className="pt-8">
        <h2 className="text-3xl font-bold text-center mb-10 text-wsy-purple flex items-center justify-center"><Briefcase className="mr-3 h-8 w-8"/>Featured Opportunities</h2>
        <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-8">
          {sampleOpportunities.map((opp) => (
            <Card key={opp.id} className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col overflow-hidden">
              <CardHeader className="pb-4">
                 <div className="flex justify-between items-start mb-2">
                    <CardTitle className="text-xl font-semibold text-wsy-blue leading-tight">{opp.title}</CardTitle>
                    <Badge variant="secondary" className="ml-2 shrink-0">{opp.company}</Badge>
                  </div>
                <CardDescription className="text-sm text-gray-600 line-clamp-2">{opp.shortDescription}</CardDescription>
              </CardHeader>
              <CardContent className="flex-grow">
                <div className="flex flex-wrap gap-2 mb-3">
                  {opp.tags.map(tag => <Badge key={tag} variant="outline" className="text-xs">{tag}</Badge>)}
                </div>
                {(opp.requirements && opp.requirements.length > 0) && 
                  <p className="text-xs text-gray-500 mt-1">Requires: {opp.requirements.slice(0,2).join(', ')}{opp.requirements.length > 2 ? '...' : ''}</p> 
                }
              </CardContent>
              <CardFooter className="bg-slate-50 p-4">
                <Button variant="purple" size="sm" className="w-full" onClick={() => openOpportunityDialog(opp)}>
